...
echo "=========================================="
echo " Regression App v0.5.8 - macOS Builder"
echo "=========================================="
echo
...
OUTPUT_DIR="$HOME/Desktop/RegressionApp-v0.5.8"
rm -rf "$OUTPUT_DIR"
mkdir -p "$OUTPUT_DIR"
...
echo "[5/5] Finished."
open "$OUTPUT_DIR"
osascript -e 'display dialog "Regression App v0.5.8 built successfully and passed its packaged self-test." buttons {"OK"} default button "OK"'
